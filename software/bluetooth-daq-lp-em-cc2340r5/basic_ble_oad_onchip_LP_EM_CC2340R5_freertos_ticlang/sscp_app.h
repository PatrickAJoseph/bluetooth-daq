...
extern void dacControlRegCallback(void* reg, int operation);
extern void hsadcControlRegCallback(void* reg, int operation);
extern void hsadcSamplesRegCallback(void* reg, int operation);
